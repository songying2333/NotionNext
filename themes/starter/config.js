...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: '这是一家关心您产品的创意拍摄公司', // 英雄区文字
  STARTER_HERO_TITLE_2: '有多关心？请看', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: '联系我们', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL:
    'https://notion-next-songgou.vercel.app/article/contact-us', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '查看我们的更多作品', // 英雄区按钮
  ...
  STARTER_FOOTER_SLOGAN: '我们通过创意为品牌和公司提升宣传体验。',
...
/  ],
  ...
  STARTER_CTA_TITLE: '需要产品创意？又或者是拍摄支持？',
  STARTER_CTA_TITLE_2: '',
  STARTER_CTA_DESCRIPTION:
    '产品您精通，拍摄我在行',
  STARTER_CTA_BUTTON: true, // 是否显示按钮
  STARTER_CTA_BUTTON_URL:
    'https://notion-next-songgou.vercel.app/article/contact-us',
